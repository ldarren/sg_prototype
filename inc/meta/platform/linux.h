/** 
 * @file	platform/linux.h
 * @brief	Linux Platform interfaces.
 * @author	Darren Liew<br>
 *			Copyright (C) 2009 Metaversum Asia Pte Ltd.
 *
 * Linux platform definitions (placeholder)
 */
#ifdef LINUX

#pragma once
#ifndef _META_PLATFORM_LINUX_H_
#define _META_PLATFORM_LINUX_H_
